...
// configuration step. It creates a namespace called `disruptor`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", disruptor::cmake::project_name, disruptor::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", disruptor::cmake::project_version);
      return EXIT_SUCCESS;
    }
